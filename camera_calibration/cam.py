...
# Experiment with these to get best results
search_radius = 3
num_images = 3
paths = glob.glob('data/left[0-1][0-9].jpg')[:min(13, num_images)]
...
for path in paths:
    ...
    if ret:
        ...
        corners = cv2.cornerSubPix(gray, corners, (search_radius, search_radius), (-1, -1), criteria)
